...
const getParticularBooks = async function (req, res) {
    let fetch = req.body
    let allBooks = await BookModel.find({ $or:[{ bookname:fetch.bookname},{tag : fetch.tags},{totalPages : fetch.totalPages},{year :fetch.year},{authorName : fetch.authorName}],} )
    return res.send({msg: allBooks})
}
